...
### Οδηγίες Εκτέλεσης (Linux / macOS / WSL)

Πριν την πρώτη εκτέλεση, πρέπει οπωσδήποτε να εκχωρηθούν δικαιώματα εκτέλεσης στο αρχείο, αλλιώς το σύστημα θα επιστρέψει σφάλμα `Permission denied`. 

Ανοίξτε το τερματικό στον κεντρικό φάκελο και εκτελέστε:

```bash
# 1. Εκχώρηση δικαιωμάτων εκτέλεσης στο script
chmod +x run.sh

# 2. Εκτέλεση του script αυτοματοποίησης
./run.sh
